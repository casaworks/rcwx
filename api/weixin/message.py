...
class Article():
	def __init__(self, title, description, pic_url, url=None):
		self.title = title
		self.description = description
		self.pic_url = pic_url
		self.url = url
...
class ImageTextMessage(NewsMessage):
    def __init__(self, from_user, to_user, title, text, image_url):
        NewsMessage.__init__(self, from_user, to_user)
        self.append_article(Article(title, None, image_url, image_url))
        self.append_article(Article(text, None, None, None))
